...
# setwd("....")
# setwd("D:/RECHERCHES/ClubBioStats/Séance_3")
...
ToothGrowth = read.csv( "ToothGrowth_Guinea.csv", sep=",", dec=",")
...
ToothGrowth2 = read.csv( "ToothGrowth_Guinea_2.csv", sep=";", dec=",")
head(ToothGrowth2)
...
# data of the PKPD model
data_model_PKPD = read.csv("data_model_PKPD.csv", sep=",", dec=".")

# ----------------------------------
# exemple pk model
# ----------------------------------

plot_pk = ggplot( data_model_PKPD, aes( x=time, y=CP) )+
...
plot_pkpd = ggplot( data_model_PKPD, aes( x=time, y=CP) ) +
